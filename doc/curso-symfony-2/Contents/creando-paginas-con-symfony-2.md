# Creando páginas con Symfony 2 # {#creando-paginas-con-symfony-2}
...
Vemos que nuestro método recibe el parámetro $name que debe coincidir con el escrito en nuestra ruta /hello/{__name__}.
